    ...
    submit = async (companyName?: string) => {
      if (this.disabled) {
        ...
        try {
          ...
          this.setAlert(ALERT_STATUS.ERROR, "Receive failed, please try again!");
        }
      }
    };
    ...
    <DashboardPage title="Receive">
      <Grid big>
        <Grid>
          ...
          <button className="payment-system click"
             onClick={() =>
              receive.submit("Stripe")}>
                ...
                <div className="payment-system__right">
                  <img src="/svg/payment-icon1.svg" alt="mastercard" />
                  <img src="/svg/payment-icon2.svg" alt="tron" />
                  <img src="/svg/payment-icon3.svg" alt="bch" />
                  <img src="/svg/payment-icon4.svg" alt="tron" />
                  <img src="/svg/payment-icon5.svg" alt="eth" />
                  <img src="/svg/payment-icon6.svg" alt="binance" />
                </div>
              </button>
              <button className="payment-system click"
             onClick={() =>
              receive.submit("Coinbase")}>
                <div className="payment-system__left">
